...
const messageMapping = {
  1: `Tailor the content to your brand voice. Simply input your company’s landing page URL. You can add additional brand voices later in the configure screen`,
  2: `Tailor the content to your brand voice. Simply input your company’s landing page URL.`,
  3: "Tailor the content to your brand voice. Simply input your company’s landing page URL.",
};
